...
Param(
    ...
    [parameter(Mandatory = $false)] $ReleaseBaseURL="https://github.com/projectcalico/calico/releases/download/v3.23.1/",
    [parameter(Mandatory = $false)] $ReleaseFile="calico-windows-v3.23.1.zip",
